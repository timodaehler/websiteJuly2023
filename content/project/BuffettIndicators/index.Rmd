...
```{r, include=FALSE}
BuffettIndicators1_update_date <- readRDS("~/Desktop/websiteJuly2023/content/project/BuffettIndicators/BuffettIndicators1_update_date.rds")
``` 

<br> <br> 
Last update: `r BuffettIndicators1_update_date` CET
...
```{r, include=FALSE}
BuffettIndicators2_update_date <- readRDS("~/Desktop/websiteJuly2023/content/project/BuffettIndicators/BuffettIndicators2_update_date.rds")
``` 

<br> <br> 
Last update: `r BuffettIndicators2_update_date` CET
